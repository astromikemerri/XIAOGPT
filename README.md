...
This should all <A href=XIAOGPTfritzing.jpg>just fit on a mini breadboard</A> (here's <A href=XIAOGPT.fzz>the Fritzing file</A>), and end up <A href=XIAOGPTimage.jpeg>looking something like this</A> (with a 10p for scale):
<p></p>
<p>
